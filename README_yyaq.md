...
![](https://raw.githubusercontent.com/kingly09/KYSecurityDefense/master/images/aq/4/cycript-Fig1.png)

一旦下载完成，用`sftp`把它从你的电脑上上传到越狱设备上。


![](https://raw.githubusercontent.com/kingly09/KYSecurityDefense/master/images/aq/4/061013_1436_iOSApplicat2.jpg)

然后使用`dpkg`命令来安装它


![](https://raw.githubusercontent.com/kingly09/KYSecurityDefense/master/images/aq/4/061013_1436_iOSApplicat3.jpg)

最后使用`cycript`命令来看是否工作正常。

![](https://raw.githubusercontent.com/kingly09/KYSecurityDefense/master/images/aq/4/061013_1436_iOSApplicat4.jpg)
...
![](https://raw.githubusercontent.com/kingly09/KYSecurityDefense/master/images/aq/4/061013_1436_iOSApplicat5.jpg)


如果挂钩成功，你可以得到一个`Cycript`解释器。你可以通过`Objective-C`的语法 `[UIApplication sharedApplication]`.来得到实例。

![](https://raw.githubusercontent.com/kingly09/KYSecurityDefense/master/images/aq/4/061013_1436_iOSApplicat6.jpg)
...
![](https://raw.githubusercontent.com/kingly09/KYSecurityDefense/master/images/aq/4/061013_1436_iOSApplicat7.jpg)

`Cycript`默认就有这个变量，用它可以很容易的得到应用的实例。


![](https://raw.githubusercontent.com/kingly09/KYSecurityDefense/master/images/aq/4/061013_1436_iOSApplicat8.jpg)

为了找到这个应用的`delegate`，我们可以用 `[UIApplication sharedApplication].delegate`. 不过既然我们已经定义了一个`a`代表应用的实例，我们可以用下图的方式来得到`delegate`。


![](https://raw.githubusercontent.com/kingly09/KYSecurityDefense/master/images/aq/4/061013_1436_iOSApplicat9.jpg)
...
![](https://raw.githubusercontent.com/kingly09/KYSecurityDefense/master/images/aq/4/061013_1436_iOSApplicat10.jpg)

正如你所看到的那样，这个应用的状态栏被隐藏了。我们可以调用方法让状态栏显示。同时，请确保我们在进行运行时分析这个应用的时候，这个应用运行在前台。

![](https://raw.githubusercontent.com/kingly09/KYSecurityDefense/master/images/aq/4/061013_1436_iOSApplicat11.jpg)

这是这个应用现在的样子。

![](https://raw.githubusercontent.com/kingly09/KYSecurityDefense/master/images/aq/4/061013_1436_iOSApplicat12.jpg)
...
![](https://raw.githubusercontent.com/kingly09/KYSecurityDefense/master/images/aq/4/061013_1436_iOSApplicat13.jpg)

现在我们按`Home`键，可以在应用的桌面图标上看到提醒数字。


![](https://raw.githubusercontent.com/kingly09/KYSecurityDefense/master/images/aq/4/061013_1436_iOSApplicat14.jpg)
...
![](https://raw.githubusercontent.com/kingly09/KYSecurityDefense/master/images/aq/4/061013_1436_iOSApplicat15.jpg)

为了找出在特定时刻的`keyWindow`。可以这么做。

![](https://raw.githubusercontent.com/kingly09/KYSecurityDefense/master/images/aq/4/061013_1436_iOSApplicat16.jpg)

`root view controller`可以用如下的方法找出来。

![](https://raw.githubusercontent.com/kingly09/KYSecurityDefense/master/images/aq/4/061013_1436_iOSApplicat17.jpg)

如你所见，`rootViewController`的名字是`YahooSlidingController`。从它的名字可以推断，它是如下图的`slider`所使用的类


![](https://raw.githubusercontent.com/kingly09/KYSecurityDefense/master/images/aq/4/061013_1436_iOSApplicat18.jpg)
